...
const PostHandler = ({eventEndlers}) => {
    ...
    {type:"text",name:"body",placeholder:"Body"}]
      ...
      return(
        <div className={styles.wrapper}>
          <div onClick={()=> eventEndlers.delete()} >
          ...
          <div onClick={()=> openModal('globalModal',<AddPostForm forms={forms} eventHandler={eventEndlers.update}/>)}>
